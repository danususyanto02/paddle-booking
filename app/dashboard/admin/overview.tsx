  ...
  return (
    <>
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
        <div className="bg-surface-container-lowest rounded-xl border border-surface-variant p-6"><div className="w-10 h-10 rounded-lg bg-mint-glace grid place-items-center text-primary"><span className="material-symbols-outlined">payments</span></div><div className="text-xs text-on-surface-variant mt-3 uppercase tracking-widest">Total Revenue</div><div className="text-2xl font-bold">{formatIDRShort(data.revenue)}</div></div>
        <div className="bg-surface-container-lowest rounded-xl border border-surface-variant p-6"><div className="w-10 h-10 rounded-lg bg-sky-tint grid place-items-center text-tertiary"><span className="material-symbols-outlined">group</span></div><div className="text-xs text-on-surface-variant mt-3 uppercase tracking-widest">Active Members</div><div className="text-2xl font-bold">{data.activeMembers}</div></div>
        <div className="bg-surface-container-lowest rounded-xl border border-surface-variant p-6"><div className="w-10 h-10 rounded-lg bg-surface-container grid place-items-center"><span className="material-symbols-outlined">calendar_today</span></div><div className="text-xs text-on-surface-variant mt-3 uppercase tracking-widest">Today&apos;s Bookings</div><div className="text-2xl font-bold">{data.todayBookings} <span className="text-xs font-normal text-on-surface-variant">({data.pending} pending)</span></div></div>
        <div className="bg-surface-container-lowest rounded-xl border border-surface-variant p-6"><div className="w-10 h-10 rounded-lg bg-lavender-mist grid place-items-center text-secondary"><span className="material-symbols-outlined">donut_large</span></div><div className="text-xs text-on-surface-variant mt-3 uppercase tracking-widest">Court Occupancy</div><div className="text-2xl font-bold">84% <span className="text-xs font-normal text-secondary">Peak Hours</span></div></div>
      </div>
